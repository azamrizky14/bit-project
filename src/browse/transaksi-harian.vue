  ...
  <main id="content" role="main" class="main">
    <div class="content container-fluid p-3 ps-0 pt-0" ref="contentDiv">
      ...
      <template v-if="isDataLoaded">
        <tableBrowseHarian :header="header" :data="data" :fields="tableFields" :settings="hotSettings" :routingLink="routing"
...
import tableBrowseHarian from '../components/tableBrowseHarian.vue'
export default {
  components: {
    tableBrowseHarian
  },
