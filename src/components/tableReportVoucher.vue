  ...
  <div>
    ...
    <div class="card">
            ...
            <b-form-group label-for="coaKasbank" invalid-feedback="Condition Harus Diisi!">
              <div class="row">
                <div class="col-8 d-flex align-items-center">
                  ...
                  <multiselect class="my-1 multiselect-md" id="coaKasbank" :options="optionsData" placeholder="Pilih "
                    v-model="newData" :multiple="false" :show-labels="false" :allow-empty="required"
                    :custom-label="customLabel" @input="listData">
                  </multiselect>
                </div>
                <div class="col-4 d-flex align-items-center">
                  <b-form-input type="date" class="form-control-sm" v-model="getDate" @change="getData"></b-form-input>
                </div>
              </div>
            </b-form-group>
          </div>
      ...
      <div class="card-body p-2 printData">
        <h2 class="text-center">Laporan Kasbank Harian</h2>
        <print :title="print" :data="hotData" :saldoAwal="saldoAwal"></print>
      </div>
    </div>
  </div>
</template>
