    ...
    <div class="row my-1">
      ...
      <div class="col-1 d-flex justify-content-end align-items-center">
        <div class="form-check form-switch d-flex align-items-center">
          <input type="checkbox" class="form-check-input" id="formSwitch1" v-model="checkedPajak" style="height: 17.5px; margin-top: 1px;">
          ...
          <template v-if="field.componentMicro.length > 0">
            <div class="row d-flex justify-content-end" v-for="micro in field.componentMicro">
              <template v-if="micro.key === 'tableTotal'">
                <div
                  :class="['border border-light bg-light d-flex justify-content-between align-items-center', micro.microClass]">
                  {{
                    micro.microName
                  }} <span>:</span></div>
                <div :class="['p-0 border border-light', micro.microClass]">
                  <input :disabled="!micro.editableTotal" :type="micro.microValue" v-model="micro.value"
