  ...
  <form>
    <div class="row my-1">
      ...
      <div class="col-4 align-items-center">
        <h4 style="display: flex;align-items: center;justify-content: center;flex-direction: column; !important">
          Work Order Create
        </h4>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="row" v-if="dataTable.length > 0">
        <div class="col-4" v-for="data in dataTable">
          <!-- List Group -->
          <ul class="list-group">
            <b>
              <li
            ...
            >
              <i class="bi bi-box-seam list-group-icon"></i><b>Hasil Proses :</b
              ><br />
              <table class="table">
                <tr>
                  <td>
                  ...
                  <td>
                    {{ data.recipeQty * multipler }} ({{ data.recipeUM }})
                  </td>
                </tr>
              </table>
            </li>
