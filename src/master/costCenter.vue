<template>
    <main id="content" role="main" class="main">
        ...
        <div class="col-4 text-center">
            <span class="h2">List Cost Center</span>
        </div>
        <hr class="mb-3 mt-1">
            </div>
        ...
        <div class="card">
            ...
            <div class="row" v-else>
              <div class="row col-lg-12">
                <div class="col-5 d-flex justify-content-between">
                  <span>Kode Cost Center</span>:
                </div>
                <div class="col-7 ps-1">{{ infoModal.content.code }}</div>
                <div class="col-5 d-flex justify-content-between">
                  <span>Nama Cost Center</span>:
                </div>
          ...
          >
            <form ref="form" class="row" @submit.stop.prevent="handleEditSubmit">
              ...
              >
                <span class="m-0">Kode Cost Center</span>
                <h3>:</h3>
              </div>
              ...
              <div
                class="col-4 d-flex align-items-start my-1 justify-content-between"
              >
                <span class="m-0">Nama Cost Center</span>
                <h3>:</h3>
              </div>
              <div class="col-md-8 my-1">
                <b-form-group
        ...
        this.$swal({
          ...
          if (result.isConfirmed) {
            ...
            if (typeData === "Item") {
              ...
              try {
                await updateCostCenter(data, uId);
                await this.ItemTable();
              } catch (error) {
                alert(error);
              }
      ...
      alertDelete(typeData, row) {
        this.$swal({
          ...
          if (result.isConfirmed) {
            if (typeData === "Item") {
              try {
                await deleteCostCenter(row._id)
                await this.ItemTable();
              } catch (error) {
                alert(error);
              }
    ...
    computed: {
      activeFields() {
        ...
        return this.sorts.map((v) => {
          ...
          if (v === "code") {
            Item["label"] = "Kode Cost Center";
          }
          if (v === "name") {
            Item["label"] = "Nama Cost Center";
          }
          if (v === "descript") {
