<template>
    <main id="content" role="main" class="main">
        ...
        <div class="col-4 text-center">
            <span class="h2">List Customer</span>
        </div>
        <hr class="mb-3 mt-1">
            </div>
            <!-- Page Header -->
            ...
            >
                ...
                <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal" no-close-on-esc
                    ...
                    <div class="row" v-if="dataId !== '' && procId !== '' && microId === ''">
                        ...
                        <b-table ref="tableMicro" :fields="microFields" :items="microservice" hover modal-scrollable
                            ...
                            <template #cell(opsiMicro)="row">
                                <div width="0px">
                                    <b-dropdown id="dropdown-right" right text="Right align" variant="primary" size="xs">
                                        ...
                                        <b-dropdown-item href="#"
                                            @click="infoMicro(row.item, row.index, $event.target)">Detail</b-dropdown-item>
                                        <b-dropdown-item href="#"
                                            @click="editMicroModal(row.item, row.index, $event.target)">Edit</b-dropdown-item>
                                        <b-dropdown-item href="#"
                                            @click="editMicroVar(row.item, row.index, $event.target)">Edit
                                            Variabel</b-dropdown-item>
                    ...
                    <div class="row" v-else>
                        ...
                        <div class="row col-lg-8">
                            ...
                            <div class="col-5 d-flex justify-content-between"><span>Customer</span>:</div>
                            ...
                            <div class="col-5 d-flex justify-content-between"><span>Type Payment</span>:</div>
                            <div class="col-7 ps-1">
                                <template v-for="payment in infoModal.content.userTypePayment">
                                    <b class="m-0">{{ payment.Name }}</b>
                                    <p class="m-0">- {{ payment.Type }} : {{ payment.Number }}</p>
                                </template>
                            </div>
                        </div>
                    </div>
                ...
                <b-modal :id="editModal.id" :title="editModal.title" @hidden="resetEditModal" @ok="handleEdit"
                    ...
                    <form ref="form" class="row" @submit.stop.prevent="handleEditSubmit">
                        <div class="col-md-12 d-flex justify-content-center align-items-center pe-5"
                            ...
                            <div class=" d-flex justify-content-center align-items-end flex-wrap h-100 pe-5">
                                <b-form-group
                                    ...
                                    @change="(event) => previewFiles(event)" tabindex="-1" :state="imageState"
                                    style="border:none">
                                    ...
                                    <b-form-input tabindex="-1" id="img1" class="js-file-attach avatar-uploader-input"
                                        v-model="image" :state="imageState" required></b-form-input>
                                </b-form-group>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group label-for="ItemName" invalid-feedback="Nama Customer Harus Diisi!"
                                :state="NameState">
                ...
                <b-modal :id="editProc.id" :title="editProc.title" no-close-on-esc
                    no-close-on-backdrop hide-header-close>
                    <form v-if="addressIndex !== ''" ref="form" class="row" @submit.stop.prevent="handleProcSubmit">
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group label-for="addrecLocation" invalid-feedback="Lokasi Harus Diisi!" :state="kabState">
                                    <b-form-input id="addrecLocation" v-model="kab" :state="kabState"
                                        required></b-form-input>
                            </b-form-group>
                        </div>
                    </form>
                    ...
                    <form v-else-if="paymentIndex !== ''" ref="form" class="row" @submit.stop.prevent="handleProcSubmit">
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group label-for="paymentNumber" invalid-feedback="Nomor Pembayaran Harus Diisi!" :state="provState">
                                <b-form-input id="paymentNumber" type="number" v-model="kab" :state="provState" required></b-form-input>
                            </b-form-group>
                        </div>
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group label-for="paymentName" invalid-feedback="Nama Pembayaran Harus Diisi!" :state="provState">
                ...
                <b-modal id="modal-add" size="lg" title="Tambah Customer" no-close-on-esc no-close-on-backdrop ref="modal"
                    ...
                    <form ref="form" class="row p-5" @submit.stop.prevent="handleSubmit">
                        ...
                        <div class="col-9 row m-0 p-0">
                            <div class="col-md-12 mb-2">
                                <b-form-group label="Kode Customer" label-for="ItemName"
                                    invalid-feedback="Kode Customer Harus Diisi!" :state="contactState">
                                    <b-form-input id="ItemName" v-model="contact" :state="contactState" required></b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-md-6 mb-2">
                                <b-form-group label="Nama Customer" label-for="ItemName"
                                    invalid-feedback="Nama Customer Harus Diisi!" :state="NameState">
                                    <b-form-input id="ItemName" v-model="name" :state="NameState" required></b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-md-6 mb-2">
                                <b-form-group label="email" label-for="ItemContact" invalid-feedback="email Harus Diisi!"
                                    :state="addressState">
                                    <b-form-input id="ItemContact" v-model="address" :state="addressState"
                                        required></b-form-input>
                                </b-form-group>
                ...
                <b-modal id="modal-addAddress" size="sm" title="Tambah Alamat" hide-header-close no-close-on-esc
                    ...
                    <form ref="form" class="row" @submit.stop.prevent="handleSubmitAddress">
                        <div class="col-md-12 mb-2">
                            <b-form-group label="Nama " label-for="addressName"
                                invalid-feedback="Nama Alamat Harus Diisi!" :state="provState">
                                <b-form-input id="addressName" v-model="prov" :state="provState" required placeholder="Masukan Nama Alamat"></b-form-input>
                            </b-form-group>
                        </div>
                        <div class="col-md-12 mb-2">
                            <b-form-group label="Alamat Lokasi" label-for="usahaLokasi" invalid-feedback="Lokasi Harus Diisi!"
                                :state="kabState">
                                <textarea class="form-control" id="usahaLokasi" v-model="kab" :state="kabState" required rows="4"></textarea>
                            </b-form-group>
                        </div>
                    </form>
                </b-modal>
...
import { getCustomer, addUser, updateCustomer } from '../components/services/components'
...
export default {
                ...
                if (result.isConfirmed) {
                    ...
                    if (typeData === 'Item') {
                        ...
                        const data = {
                            ...
                            userContactPerson: this.optionAddress,
    ...
    resetEditArray() {
        ...
        handleSubmit() {
            if (this.name && this.type && this.desc && this.address) {
                this.alertAdd('Item')
            }
            // add validation
            if (!this.name) {
