        ...
        <div class="content container-fluid">
            ...
            <div class="card mb-3 mb-lg-5">
                ...
                <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal" no-close-on-esc
                    ...
                    <div class="row">
                        <div class="col-4 d-flex justify-content-between"><span>Kode Akun</span>:</div>
                        <div class="col-8 ps-1">{{ infoModal.content.itemCoA }}</div>
                        <div class="col-4 d-flex justify-content-between"><span>Kode Item</span>:</div>
                        <div class="col-8 ps-1">{{ infoModal.content.itemCode }}</div>
                        <div class="col-4 d-flex justify-content-between"><span>Nama Item</span>:</div>
                        <div class="col-8 ps-1">{{ infoModal.content.itemName }}</div>
                        <div class="col-4 d-flex justify-content-between"><span>Kategori</span>:</div>
                        <div class="col-8 ps-1">{{ infoModal.content.itemCategory }}</div>
                        <div class="col-4 d-flex justify-content-between"><span>Deskripsi</span>:</div>
                        <div class="col-8 ps-1">{{ infoModal.content.itemDesc }}</div>
                        <div class="col-md-12 mt-2">
                            <div class="px-2 d-flex justify-content-between align-items-center" style="background: #113448">
                                <span class="text-white m-0">Price</span>
                                <div class="d-flex align-items-center">
                                    <button v-if="showPrice" @click="showPrice = !showPrice" type="button" class="btn p-0"
                            ...
                            <table v-if="showPrice" class="table border">
                                ...
                                <tbody>
                                    <tr v-for="(price, i) in infoModal.content.itemMasterPrice" :key="i">
                                        <td class="align-top">{{ price.priceName }}</td>
                                        <td>
                                            <p class="m-0" v-for="data in price.priceData">{{ data.priceQty }}</p>
                                        </td>
                                        <td>
                                            <p class="m-0" v-for="data in price.priceData">{{ data.priceValue }}</p>
                                        </td>
                ...
                <b-modal :id="editModal.id" :title="editModal.title" @hidden="resetEditModal" @ok="handleEdit"
                    ok-title="Edit" ok-variant="success">

                    <form ref="form" class="row" @submit.stop.prevent="handleSubmit">
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Nama Item" label-for="itemName" invalid-feedback="Nama Item Harus Diisi!"
                                :state="NameState">
                        ...
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Kode Akun" label-for="itemCat"
                                ...
                                <multiselect id="itemCat" v-model="type" :options="optionsCoa" placeholder="Select one"
                                    :taggable="false" :multiple="false" track-by="coaCode" :show-labels="false"
                                    :custom-label="customLabel" :allow-empty="required">
                                </multiselect>
                            </b-form-group>
                        </div>
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Kode Item" label-for="itemCode" invalid-feedback="Kode Item Harus Diisi!"
                                :state="groupState">
                                <b-form-input id="itemCode" v-model="group" :state="groupState" required></b-form-input>
                            </b-form-group>
                        </div>
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Kategori" label-for="itemCat" invalid-feedback="Kategori Item Harus Diisi!"
                                :state="katState">
                                <b-form-select class="form-control" :options="optionsJenis" id="itemCat" v-model="kat"
                                    :state="katState" required></b-form-select>
                            </b-form-group>
                        </div>
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Kategori" label-for="itemCat" invalid-feedback="Kategori Item Harus Diisi!"
                        ...
                        <div class="col-md-6 mb-2">
                            <b-form-group label="Deskripsi" label-for="itemDefStatus"
                                invalid-feedback="Deskripsi Harus Diisi!" :state="descState">
                                <b-form-input id="itemDefStatus" v-model="desc" :state="descState" required></b-form-input>
                            </b-form-group>
                        </div>
                        <div class="col-md-6 mb-2">
                            <b-form-group label="UM" label-for="itemSatuan" invalid-feedback="Anda Harus Memilih Satuan!"
                                :state="dateState">
                                <multiselect id="itemSatuan" v-model="date" :options="optionsUm" placeholder="Select"
                                    :taggable="true" @tag="addConvert1" :multiple="false" track-by="name" label="name"
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="px-2 d-flex justify-content-between align-items-center" style="background: #113448">
                                <span class="text-white m-0">Price</span>
                                <div class="d-flex align-items-center">
                                    <button type="button" v-b-modal.modal-addPrice class="btn p-0" data-toggle="tooltip"
                            ...
                            <table v-if="showPrice" class="table border">
                                ...
                                <tbody>
                                    <tr v-for="(price, i) in optionPrice" :key="i">
                                        <td>{{ price.priceName }}</td>
                                        <td>{{ price.priceCode }}</td>
                                        <td>{{ price.priceData.length }}</td>
                                        <td class="text-center">
                                            <button type="button" class="btn p-0"
                                                @click="editPrice1(price, i, $event.target)">
                                        ...
                                        <td>
                                            <b-form-group>
                                                <b-form-input :disabled="optionPrice.length === 0 && optionAdd.length === 0"
                                                    type="number" id="priceValue" v-model="price.priceQty"
                                                    required :class="price.priceQty === '' ? 'is-invalid' : ''"></b-form-input>
                                            </b-form-group>
                                        </td>
                                        <td>
                                            <b-form-group>
                                                <b-input-group prepend="Rp.">
                                                    <input v-format-number class="form-control"
                                                        :disabled="optionPrice.length === 0 && optionAdd.length === 0"  id="priceValue" v-model="price.priceValue"
                                                        required :class="price.priceValue === '' ? 'is-invalid' : ''">
                                                </b-input-group>
                                            </b-form-group>
                                        </td>
                                        <td>
                                    ...
                                    <div class="row col-md-9">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <b-form-group label="Grup" label-for="itemJenis"
                                                invalid-feedback="Jenis Item Harus Diisi!">
                                                <multiselect v-model="general.group" :options="optionsGroup"
                                                    :multiple="true" :clear-on-select="false" :preserve-search="true"
                                                    :class="general.group === null ? 'invalid' : ''"
                                                    placeholder="Pilih Grup">
                                                    <template slot="selection" slot-scope="{ values, search, isOpen }"><span
                                                            class="multiselect__single" v-if="values.length"
                                                            v-show="!isOpen">{{ values.length }} data dipilih</span>
                                                    </template>
                                                </multiselect>
                                        ...
                                        <div class="px-2 d-flex justify-content-between align-items-center"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button v-if="showTopping" @click="showTopping = !showTopping" type="button"
                                                    ...
                                                    <i class="bi bi-caret-up-square text-white"
                                                        style="font-size: 20px;"></i>
                                                </button>
                                                <button v-else @click="showTopping = !showTopping" type="button"
                                                    class="btn p-0" data-toggle="tooltip" title="Show">
                                                    <i class="bi bi-caret-down-square text-white"
                                                        style="font-size: 20px;"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <table v-if="showPrice" class="table border">
                                            ...
                                            <tbody>
                                                <tr v-for="(price, i) in optionAdd" :key="i">
                                                    ...
                                                    <td>
                                                        <p v-for="data in price.masterPrice">{{ data.priceQty }}</p>
                                                    </td>
                                                    <td>
                                                        <p v-for="data in price.masterPrice">{{ data.priceValue }}</p>
                                                    </td>
                                                    <td class="text-center align-top">
                                                        <button type="button" class="btn p-0"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="px-2 d-flex justify-content-between align-items-center bg-primary">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button v-else @click="showDiskon = !showDiskon" type="button"
                                                    class="btn p-0" data-toggle="tooltip" title="Show">
                                                    <i class="bi bi-caret-down-square text-white"
                                                        style="font-size: 20px;"></i>
                                                </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <b-form-group label="PO receipt" label-for="itemJenis"
                                            invalid-feedback="Jenis Item Harus Diisi!">
                                            <multiselect id="itemJenis" v-model="inventory.poReceipt"
                                                :options="optionsLocation" placeholder="Lokasi Default PO receipt"
                                                :multiple="false" :allow-empty="required" :show-labels="false"
                                                :custom-label="labelLocation">
                                            </multiselect>
                                        </b-form-group>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <b-form-group label="WO receipt" label-for="itemJenis"
                                            invalid-feedback="Jenis Item Harus Diisi!">
                                            <multiselect id="itemJenis" v-model="inventory.woReceipt"
                                                :options="optionsLocation" placeholder="Lokasi Default WO receipt"
                                                :multiple="false" :allow-empty="required" :show-labels="false"
                                                :custom-label="labelLocation">
                                            </multiselect>
                                        </b-form-group>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <b-form-group label="Minimal Qty. Produksi" label-for="itemJenis"
                                            ...
                                            <b-input-group append="pcs">
                                                <b-form-input v-model="inventory.minQty" type="number"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="px-2 d-flex justify-content-between align-items-center"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button v-else @click="showRecipe = !showRecipe" type="button"
                                                    class="btn p-0" data-toggle="tooltip" title="Show">
                                                    <i class="bi bi-caret-down-square text-white"
                                                        style="font-size: 20px;"></i>
                                                </button>
                                        ...
                                        <table v-if="showRecipe" class="table border">
                                            ...
                                            <tbody>
                                                <tr v-for="(recipe, i) in optionRecipe" :key="i">
                                                    ...
                                                    <td class="align-top">{{ recipe.recipeItemResult.itemName }}</td>
                                                    <td class="align-top text-center">
                                                        <button type="button" class="btn p-0"
                                                            @click="editRecipe(recipe, i, $event.target)">
                                                            <i class="bi bi-pencil-square text-warning"></i>
                                                        </button>
                                                            
                                                        <button type="button" class="btn p-0" @click="removeData(i, 'optionRecipe')">
                                                            <i class="bi bi-trash text-danger"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="px-2 d-flex justify-content-between align-items-center bg-primary">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button v-else @click="showConvert = !showConvert" type="button"
                                                    class="btn p-0" data-toggle="tooltip" title="Show">
                                                    <i class="bi bi-caret-down-square text-white"
                                                        style="font-size: 20px;"></i>
                                                </button>
                                        ...
                                        <table v-if="showConvert" class="table border">
                                            ...
                                            <tbody>
                                                <tr v-for="(convert, i) in optionConvert" :key="i">
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn p-0"
                                                            @click="editPrice(convert, i, $event.target)">
                                                            <i class="bi bi-pencil-square text-warning"></i>
                                                        </button>
                                                        <button type="button" class="btn p-0" @click="removeData(i, 'optionConvert')">
                                                            <i class="bi bi-trash text-danger"></i>
                                                        </button>
                                                    </td>
                                                </tr>
...
import { getItem, addItems, updateItems, getCoa, get5, get6, get7, getN, getDataDistinc, getListArrItem } from '../components/services/components'
    ...
    methods: {
        ...
        saveEditAdd() {
            if (this.title) {
                ...
                this.optionAdd[this.priceIndex].name = this.title
        ...
        edit(usaha, index, button) {
            ...
            this.name = this.editModal.content.itemName
            this.type = this.optionsCoa.find(x => x.coaCode === this.editModal.content.itemCoA)
            this.group = this.editModal.content.itemCode
            this.kat = this.editModal.content.itemCategory
            this.desc = this.editModal.content.itemDesc
            this.date = this.optionsUm.find(x => x.name === this.editModal.content.itemUM)
            console.log(this.date)

            this.optionPrice = this.editModal.content.itemMasterPrice
        },
        ...
        handleEditSubmit() {
            if (this.name && this.type && this.group && this.kat) {
                ...
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const data = {
                            ...
                            itemDesc: this.desc,
                            itemUM: this.date.name,
                            itemMasterPrice: this.optionPrice
                        }

                        console.log(id, data)
                        await updateItems(data, id);
                ...
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const defaultPrice = {
                            ...
                            priceGroup: "Default",
                            priceQty: "1",
                            priceValue: this.finance.defaultPrice,
                            priceStartDate: this.currentDate,
                            priceEndDate: ""
                        }
                        finalPrice.push(defaultPrice)
                        const tes = await getUsaha()
                        const moreData = {
                                itemPOReceipt: this.inventory.poReceipt._id,
                                itemWOReceipt: this.inventory.woReceipt._id,
                            }
                        ...
                        const data = {
                            ...
                            // Inventory
                            itemMinRecipe: this.inventory.minQty,
                            itemKonversi: JSON.stringify(this.optionConvert),
                        }
