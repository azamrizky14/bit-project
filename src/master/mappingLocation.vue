<template>
    <main id="content" role="main" class="main">
      <!-- Content -->
            ...
            <ul class="breadcrumb m-1 mt-0">
                ...
                <li>Mapping Location</li>
            </ul>
        </div>
        <div class="col-4 text-center">
            <span class="h2">List Mapping Location</span>
        </div>
        <hr class="mb-3 mt-1">
            </div>
        ...
        <div class="card">
          ...
          >
            <form ref="form" class="row" @submit.stop.prevent="handleEditSubmit">
              ...
              >
                <span class="m-0">Location Code</span>
                <h3>:</h3>
              </div>
              ...
              <div
                class="col-4 d-flex align-items-center justify-content-between"
              >
                <span class="m-0">Location Nama</span>
                <h3>:</h3>
              </div>
              <div class="col-md-8 my-1">
                <b-form-group
              ...
              <div
                class="col-4 d-flex align-items-center justify-content-between"
              >
                <span class="m-0">Detail Alamat</span>
                <h3>:</h3>
              </div>
              <div class="col-md-8 my-1">
                <b-form-group
                  label-for="typeDetail Alamat"
                  invalid-feedback="Tipe Detail Alamat Harus Diisi!"
                  :state="typeState"
                >
                <b-form-textarea
      id="typeDetail Alamat"
      v-model="type"
            ...
            <form ref="form" class="row p-5" @submit.stop.prevent="handleSubmit">
              <div class="col-md-12 mb-2">
                <b-form-group
                  ...
                  invalid-feedback="Kode Location Harus Diisi!"
                  :state="NameState"
                >
                  <b-form-input
                    id="codeLocation"
              ...
              <div class="col-md-12 mb-2">
                <b-form-group
                  label="Nama Location"
                  label-for="ItemName"
                  invalid-feedback="Nama Location Harus Diisi!"
                  :state="descState"
                >
                  <b-form-input
                    id="ItemName"
              ...
              <div class="col-md-12 mb-2">
                <b-form-group
                  ...
                  invalid-feedback="Detail Alamat Harus Diisi!"
                  :state="typeState"
                >
    ...
    ></b-form-textarea>
          ...
          >
            <form ref="form" class="row" @submit.stop.prevent="handleMicroSubmit">
              ...
              <div class="col-md-6 mb-2">
                <b-form-group
                  class="h4 my-1"
                  label="Detail Alamat Microservice"
                  label-for="microDesc"
                >
          ...
          >
            <form ref="form" class="row" @submit.stop.prevent="handleSubmitProc">
              ...
              <div class="col-md-12 mb-2">
                <b-form-group label="Detail Alamat" label-for="ItemDesc">
  ...
  export default {
    data() {
      return {
        ...
        procFields: [
          ...
          { key: "appProcDesc", label: "Detail Alamat" },
        ...
        microFields: [
          ...
          { key: "microDescription", label: "Detail Alamat" },
    ...
    methods: {
      ...
      async ItemTable() {
        const data = await getMappingLocation();
        console.log(data)
        this.Item = data
        ...
        this.$swal({
          ...
          if (result.isConfirmed) {
            ...
            if (typeData === "Item") {
              ...
              try {
                await updateMappingLocation(data, uId);
                await this.ItemTable();
              } catch (error) {
                alert(error);
              }
          ...
          if (result.isConfirmed) {
            if (typeData === "Item") {
              try {
                ...
                await updateMappingLocation(data, row._id)
                await this.ItemTable();
              } catch (error) {
                alert(error);
              }
    ...
    computed: {
      activeFields() {
        ...
        return this.sorts.map((v) => {
          ...
          if (v === "code") {
            Item["label"] = "Location Code";
          }
          if (v === "name") {
            Item["label"] = "Location Name";
          }
          if (v === "descript") {
            Item["label"] = "Detail Alamat";
          }
          return Item;
        });
      },
