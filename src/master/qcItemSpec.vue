            ...
            <!-- Header -->
                ...
                <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal" no-close-on-esc no-close-on-backdrop hide-header-close>
                    ...
                    <div class="row" v-else>
                        ...
                        <div class="col-5 d-flex justify-content-between"><span>Nama QC Item Spec</span>:</div>
                ...
                <b-modal :id="editModal.id" :title="editModal.title" @hidden="resetEditModal"
                    ...
                    <form ref="form" class="row" @submit.stop.prevent="handleEditSubmit">
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group
                                label-for="ItemName"
                                invalid-feedback="Nama QC Item Spec Harus Diisi!"
                                :state="NameState"
                                >
                                <b-form-input
                                    id="ItemName"
                ...
                <b-modal id="modal-add" size="lg" title="Tambah QC Item Spec" 
                    no-close-on-esc
...
alertDelete(typeData, data) {
  ...
  async mounted() {
    ...
    this.$store.commit('setTopbarTitle', "Data QC Item Spec");
