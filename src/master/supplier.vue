<template>
    <main id="content" role="main" class="main">
        ...
        <div class="col-4 text-center">
            <span class="h2">List Suppier</span>
        </div>
        <hr class="mb-3 mt-1">
            </div>
            <!-- Page Header -->
            <div class="card">
                ...
                <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal" no-close-on-esc
                    ...
                    <div class="row">
                        ...
                        <div class="row col-lg-8">
                            ...
                            <div class="col-5 d-flex justify-content-between"><span>Supplier</span>:</div>
                ...
                <b-modal :id="editModal.id" :title="editModal.title" @hidden="resetEditModal" @ok="handleEdit"
                    ...
                    <form ref="form" class="row" @submit.stop.prevent="handleEditSubmit">
                        ...
                        <div class="col-md-8 my-1">
                            <b-form-group label-for="ItemName" invalid-feedback="Nama Supplier Harus Diisi!"
                                :state="NameState">
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="p-2 bg-primary d-flex justify-content-between align-items-center">
                                <span class="h3 text-white m-0">Alamat</span>
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="p-2 bg-dark d-flex justify-content-between align-items-center">
                                <span class="h3 text-white m-0">Payment Type</span>
                                <div class="d-flex align-items-center">
                ...
                <b-modal id="modal-add" size="lg" title="Tambah Supplier" no-close-on-esc no-close-on-backdrop ref="modal"
                    ...
                    <form ref="form" class="row p-5" @submit.stop.prevent="handleSubmit">
                        ...
                        <div class="col-9 row m-0 p-0">
                            <div class="col-md-12 mb-2">
                                <b-form-group label="Kode Supplier" label-for="ItemName"
                                    invalid-feedback="Kode Supplier Harus Diisi!" :state="contactState">
                                    <b-form-input id="ItemName" v-model="contact" :state="contactState" required></b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-md-6 mb-2">
                                <b-form-group label="Nama Supplier" label-for="ItemName"
                                    invalid-feedback="Nama Supplier Harus Diisi!" :state="NameState">
                                    <b-form-input id="ItemName" v-model="name" :state="NameState" required></b-form-input>
                                </b-form-group>
                            </div>
                            <div class="col-md-6 mb-2">
...
import { getSupplier, addUser, updateSupplier } from '../components/services/components'
