  ...
  <main id="content" role="main" class="main">
    <div class="content container-fluid p-3 ps-0 pt-0" ref="contentDiv">
      ...
      <template v-if="isDataLoaded">
        <tableReportInventory :header="header" :data="data" :fields="tableFields" :settings="hotSettings" :routingLink="routing"
...
import tableReportInventory from '../components/tableReportInventory.vue'
export default {
  components: {
    tableReportInventory
  },
  data() {
    return {
      filterText: '',
