  ...
  <main id="content" role="main" class="main">
    <div class="content container-fluid p-3 ps-0 pt-0" ref="contentDiv">
      <ul class="breadcrumb m-1 mt-0">
        ...
        <li>Laporan Kasbank Harian</li>
      </ul>
      <!-- Content -->
      <template v-if="isDataLoaded">
        <tableReportHarian :header="header" :data="data" :fields="tableFields" :settings="hotSettings" :routingLink="routing"
...
import tableReportHarian from '../components/tableReportHarian.vue'
export default {
  components: {
    tableReportHarian
  },
