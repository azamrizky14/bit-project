...
export default {
  ...
  methods: {
    ...
    fetchPosts() {
      ...
      var mockResponse = [
        {
          transTitle: 'Good Receipt',
            transRouting: 'good-receipt',
          transProperties: [
            {dataName: 'menuAdd', dataMicro: [
              {componentName: 'fieldHeader', componentTitle: '', componentClass: 'col-md-6', componentMicro: [
                {key:'journal', microName: 'Kode PR', microType: 'text', microText: 'Masukan kode purchase request', microClass: 'my-2'},
                {key:'code', microName: 'Kode PO', microType: 'text', microText: 'Masukan Kode purchase order', microClass: 'my-2'},
                {key:'code', microName: 'Kode GR', microType: 'text', microText: 'Masukan Kode good receipt', microClass: 'my-2'},
              ]},
              {componentName: 'fieldHeader', componentTitle: '', componentClass: 'col-md-6', componentMicro: [
                {key: 'date', microName: 'Inspection Date', microType: 'date', microText: 'Masukan tanggal', microClass: 'my-2'},
                {key: 'user', microName: 'Inspector', microType: 'text', microText: 'Masukan petugas inspeksi', microClass: 'my-2'},
              ]},
              {componentName: 'fieldTable', componentTitle: '', componentClass: 'col-md-12', componentMicro: [
                {key: 'tableNama',microName: 'Nama Item', microType: 'text', width:0, microText: 'Masukan Nama', microClass: ''},
                {key: 'tableDesc',microName: 'Lot Serial Number', microType: 'text', width:0, microText: 'Masukan Spesifikasi', microClass: ''},
                {key: 'tableReff',microName: 'UM', microType: 'text', width:100, microText: 'Masukan Nama', microClass: ''},
                {key: 'tableCredit',microName: 'Qty. Receipt', microType: 'numeric', width:0, microText: 'Masukan Quantity', microClass: ''},
                {key: 'tableQty',microName: 'Qty GR', microType: 'numeric', width:0, microText: 'Masukan Unit', microClass: ''},
                {key: 'tableDebit',microName: 'Qty Reject', microType: 'numeric', width:0, microText: 'Masukan Unit', microClass: ''},
              ]},
              ...
              {componentName: 'fieldTotal', componentTitle: 'Total', componentClass: 'col-md-12', componentMicro: [
                {key: 'tableCredit',microName: 'Total Barang', value: 0, microType: 'number', microMath: 'plus', microClass: 'col-md-4'},
                {key: 'tableDebit',microName: 'Total Ditolak', value: 0, microType: 'number', microMath: 'minus', microClass: 'col-md-4'},
                {key: 'tableQty',microName: 'Total Diterima.', value: 0, microType: 'number', microMath: 'plus', microClass: 'col-md-4'},
                {key: 'total',microName: 'Total', value: 0, microType: 'number', microClass: 'col-md-4 d-none'}
              ]},
