<template>
  <main id="content" role="main" class="main">
    <div class="content container-fluid p-3 ps-0 py-0" ref="contentDiv">
      <transaksiDetail :posts="posts" :component="component" :hotSettings="hotSettings" :widthTable="contentDivWidth" :dataDetail="dummyData" :refreshMethods="refreshValue()"></transaksiDetail>
    </div>
  </main>
</template>
...
export default {
  ...
  methods: {
    ...
    findData() {
      const headerData = this.dataDetail.header[0];
      const footerData = this.dataDetail.footer[0];
