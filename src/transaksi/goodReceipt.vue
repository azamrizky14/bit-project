      ...
      var mockResponse = [
        {
          ...
          transProperties: [
            {dataName: 'fieldTable', dataMicro: [
              ...
              {key: 'codeGR',microName: 'Kode GR', microType: 'text', width:110, microText: 'Masukan Nama', microClass: ''},
              {key: 'dateInsp',microName: 'Inspection Date', microType: 'date', width:0, microText: 'Masukan Kode', microFormat: 'DD-MM-YYYY', microClass: ''},
              {key: 'inspector',microName: 'Inspector', microType: 'text', width:0, microText: 'Masukan Spesifikasi', microClass: ''},
              {key: 'note',microName: 'Catatan', microType: 'text', width:0, microText: 'Masukan Spesifikasi', microClass: ''},
              {key: 'opsi',microName: '', microType: 'dropdown', width:0, microText: 'Masukan Spesifikasi', microClass: ''},
            ]},
          ...
          transData: [
            {
              codeGR:'GR00001', codePO: 'PO00001', dateInsp: '2023-12-01', inspector: 'mamat', note: 'data lengkap', dataTable: [
