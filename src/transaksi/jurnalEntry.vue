...
import { get1, getJE } from '../components/services/components'
  ...
  async mounted() {
    ...
    (this.tableHeader = [
      ...
      },
      {
        ...
        label: "COA Code",
        sortable: true,
        class: "align-top", thClass: "text-center", thStyle: "width:85px"
      },
      {
        key: "coaName",
        label: "COA Name",
      ...
      },
      {
        ...
        label: "Trans Type",
        sortable: true,
        class: "align-top text-center", thClass: "" , thStyle: "width:85px"
      },
      {
        key: "coaTrans",
        label: "Jurnal Lawan",
        sortable: true,
        class: "align-top text-center", thClass: ""
      },
      {
        key: "coaTrans[0].transEffDate",
        label: "Trans Date",
        sortable: true,
        class: "align-top text-center", thClass: "", thStyle: "width:100px"
      },
